...
export const Hero = () => {
  ...
  return (
    <div className='flex flex-col min-h-[400px] items-center gap-8 justify-center text-center mt-10 md:mt-20'>
      ...
      {/* demo video section */}
      <div className="relative aspect-video translate-y-10 md:translate-y-0 w-[330px] md:w-3xl lg:max-w-5xl mx-auto rounded-2xl overflow-hidden shadow-lg">
        <iframe
      ...
      {/* hero-AiButton */}
      <div className="fixed bottom-12 left-1/2 -translate-x-1/2 w-[95%] max-w-[750px] bg-white/10 dark:bg-black/10 backdrop-blur-md border border-neutral-300/50 dark:border-white/10 rounded-2xl shadow-xl flex items-center gap-3 p-2 group transition-all duration-300 hover:border-purple-500/30">
        <textarea
          value={prompt}
          onChange={(e) => {
            setAiResponse([])
