    ...
    <div className='flex flex-col min-h-[400px] items-center gap-8 justify-center text-center space-y-6 mt-20'>
        ...
        <div className='flex flex-col gap-3' >
            ...
            <div className='flex flex-col '>
              <p className='text-sm md:text-md lg:text-lg'>Your AI-powered scheduling assistant. Send a prompt, get your day crafted!</p>
              <p className='text-xs md:text-sm lg:text-md'>Sign up today and take the first step towards a more organized and productive life</p>
            </div>
        </div>
        {/* hero-AiButton */}
        <div className=''>
            <div className='w-[800px] h-[100px] p-6 items-end border-1 gap-1 border-neutral-500 rounded-md shadow-md flex'>
