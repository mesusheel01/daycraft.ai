    ...
    <div className="min-h-screen  flex items-center justify-center">
      <div className="border-1 border-neutral-500 dark:border-neutral-700 bg-gradient-to-b from-background via-card to-tertiary shadow-xl rounded-2xl m-6 p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="username" className="block text-sm text-tertiary font-medium ">Username</label>
            <input
              value={username}
          ...
          <div>
            <label htmlFor="password" className="block text-sm text-tertiary  font-medium ">Password</label>
            <input
              value={password}
          ...
          <button
            ...
            className="w-full border-1 transition-colors duration-300  py-2 px-4 bg-popover hover:bg-accent-foreground font-semibold rounded-md "
          >
            {msg}
          </button>
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="w-full py-2 px-4 bg-neutral-900 hover:bg-neutral-800 text-white font-semibold border-1 border-tertiary dark:border-transparent transition-colors duration-300 rounded-md flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-2 px-4 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-semibold rounded-md flex items-center justify-center gap-2 transition-colors duration-300"
          >
